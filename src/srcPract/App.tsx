...
function App() {
	...
	let [tasks, setTasks] = useState<TasksType>({
		[todolistId1]: {
			data: [
				{ id: '0', title: 'HTML&CSS1111', isDone: true },
				{ id: '1', title: 'JS1111', isDone: true },
			],
			filter: 'all',
		},
		[todolistId2]: {
			data: [
				{ id: '0', title: 'HTML&CSS22222', isDone: true },
				{ id: '1', title: 'JS2222', isDone: true },
			],
			filter: 'all',
		},
	});
	...
	function addTask(todolistId: string, title: string) {
		let newTask = {
			id: String(tasks[todolistId1].data.length),
			title: title,
			isDone: false,
		};
		setTasks({
